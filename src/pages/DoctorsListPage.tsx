...
export default function DoctorsListPage() {
    ...
    if (!doctorPage || doctorPage.content.length === 0) {
        return <div className="p-8 text-center text-white">Tidak ada dokter ditemukan.</div>;
    }

    return (
        <div className="p-8">
            {/* Tambahkan text-white pada judul */}
            <h1 className="text-3xl font-bold mb-6 text-white">Daftar Dokter Kami</h1>
